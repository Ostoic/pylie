...
structure_constants = {}
structure_constants[(x, y)] = h
structure_constants[(x, h)] = -2 * x
structure_constants[(y, h)] = 2 * y
structure_constants[(y, x)] = - structure_constants[(x, y)]
structure_constants[(h, x)] = - structure_constants[(x, h)]
structure_constants[(h, y)] = - structure_constants[(y, h)]
...
def bracket_impl(a, b):
	...
	if b_factors == ():
		...
		if a_factors == ():
			res = coefficient * structure_constants[(a, b)]
			indent -= 1
			return res
